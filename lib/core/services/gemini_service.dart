    ...
    try {
      ...
      parts.add(
        TextPart(
          ...
          "      \"mistake_example\": \"<LaTeX MATH ONLY. Show the context: 'Source = Deviation'. e.g. '(b-2)^2 = 2b-4'. Use standard LaTeX: '\\\\frac{a}{b}', 'x^2'>\","
          "      \"correction_example\": \"<LaTeX MATH ONLY. Show the intermediate step: 'Source = Intermediate = Result'. e.g. '(b-2)^2 = (b-2)(b-2) = b^2-4b+4'. Use standard LaTeX.>\","
